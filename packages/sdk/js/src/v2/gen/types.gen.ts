...
export type Config = {
  ...
  permission?: PermissionConfig
  /**
   * Enable YOLO mode - skips ALL permission prompts. Use at your own risk. OpenCode will execute file changes, bash commands, and other operations without asking for confirmation.
   */
  yolo?: boolean
  tools?: {
    [key: string]: boolean
